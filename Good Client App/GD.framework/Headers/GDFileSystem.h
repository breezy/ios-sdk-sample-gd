 ...
 *
 * \see <A HREF="http://developer.apple.com/library/ios/#referencelibrary/GettingStarted/GettingStartedWithCoreData/_index.html%23//apple_ref/doc/uid/TP40005316"
 *     target="_blank"
 * >Core Data Starting Point in the
...
/**< Move file out of the default file system.
 * \deprecated
 * This function is deprecated and will be removed in a future release. The
 ...
 *
 * Call this function to move a file from the default file system
 * into the secure store.
 *
 * The file is first added to the store, in an encrypted form.
 * The original file is then deleted.
 * If adding fails for any reason, the original file is not deleted.
 * If deletion of the original fails, the encrypted file in the store
 * is not deleted.
 *
 * The path of the original file in the default file system will be the path of
 * the encrypted file in the secure file system.
 *
 * Note. There is no reverse function that moves a file out of the
 * secure file system.
 *
 ...
 *
 * \return <TT>YES</TT> if the file was added to the secure store,
