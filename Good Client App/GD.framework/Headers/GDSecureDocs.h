 ...
 *     target="_blank"
 * >Good for Enterprise product information</A
 * > on the good.com corporate website.
 * \see <A
 *     href="http://www.good.com/support/documentation/"
 *     target="_blank"
 * >Good for Enterprise documentation</A
 * > on the good.com corporate website.
 * \see <A
 *     href="https://community.good.com/docs/DOC-1239" target="_blank"
 * >Secure Documents API Question & Answer</A
 * > document for an introduction to the Secure Documents feature.
 ...
 * -# In the application code, call
 * \link GDiOS::authorize:andVersion:withDelegate: authorize (GDiOS)\endlink
 * in the usual way.
 * .
