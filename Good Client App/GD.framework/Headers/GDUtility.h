 ...
 * challenge string as a parameter.
 *
 ...
 * Runtime may connect to the GD infrastructure installed at the enterprise in
 ...
 * The challenge string can be empty. Passing <TT>nil</TT> is allowed and
 * has the same effect as passing an empty string.
 *
 */
