 ...
 *
 * \see <A HREF="http://developer.apple.com/library/ios/documentation/Cocoa/Reference/Foundation/Classes/NSMutableURLRequest_Class" target="_blank"
 * >NSMutableURLRequest class reference</A
 * > in the iOS Developer Library on apple.com
 * \see
 * <A HREF="http://developer.apple.com/library/ios/documentation/UIKit/Reference/UIWebView_Class" target="_blank"
 * >UIWebView class reference</A
 * > in the iOS Developer Library on apple.com
 * \see
 * <A HREF="http://developer.apple.com/library/mac/#documentation/Cocoa/Conceptual/DisplayWebContent/DisplayWebContent.html"
 * target="_blank">WebKit Objective-C Programming Guide</A
 * > in the Mac Developer Library on apple.com
 *
